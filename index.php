...
<body class="bg-light">
	<div class="text-center p-5">
		...
		<h4>You can download videos <b>without Watermark</b> too. <br> Website by <b>Dev Singh Rajput</b> <br> Contact me on <a target="_blank" href="https://www.facebook.com/profile.php?id=100008474535974">Facebook</a> or Contact me on <a target="_blank" href="https://t.me/The_magneto">Telegram</a></h4>
		
	</div>
	<div class="text-center">
		Please Note :- Please use VPN, Otherwise you will not be able to download/play video. <br> Paste a video url below and press "Download". Now scroll down to "Download Video" button and press to initiate the download process.<br><br>
	...
	<div class="border m-3 mb-5" id="result">
		...
		<div class="row m-0 p-2">
			...
			<div class="col-sm-6 col-md-6 col-lg-6 text-center mt-5"><ul style="list-style: none;padding: 0px">
				...
				<li><button class="btn btn-primary mt-3" onclick="window.location.href='<?php echo $contentURL; ?>'">Download Video (with watermark)</button> <button class="btn btn-info mt-3" onclick="window.location.href='<?php echo $cleanVideo; ?>'">Download Video (without watermark)</button></li>
	...
	<div class="bg-dark text-white" style="position: fixed; bottom: 0;width: 100%;padding:15px">Developed by <a target="_blank" href="https://www.facebook.com/profile.php?id=100008474535974">Dev Singh Rajput</a> <span style="float: right;">Copyright &copy; <?php echo date("Y"); ?></span></div>
